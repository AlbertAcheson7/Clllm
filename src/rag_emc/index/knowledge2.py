...
collection_hierarchical = chroma_client.get_or_create_collection(name="ctd_hierarchical")
collection_synonym = chroma_client.get_or_create_collection(name="ctd_synonym")
collection_definition = chroma_client.get_or_create_collection(name="ctd_definition")

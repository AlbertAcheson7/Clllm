...
def parse_args():
    ...
    parser.add_argument("--dict-train", default="data/bc5cdr-DictMatching/train.txt")
    parser.add_argument("--chatgpt-train", default="data/bc5cdr-ChatGPT/train.txt")
    parser.add_argument(
        "--gold-dev",
        default="data/data_pre/data_pred/BC5CDR/merged_bc5cdr_development_data.json",
    )
    parser.add_argument(
        "--gold-test",
        default="data/data_pre/data_pred/BC5CDR/merged_bc5cdr_test_data.json",
    )
    parser.add_argument(
        "--model-name",
        default="microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext",
    )
    parser.add_argument("--output-dir", default="experiments/runs/ner_span_pruner")
